...
namespace Accsm\ResellerSDK;

/*
|-------------------------------------------------------------------
| Accsmaster reseller Api SDK v1
|-------------------------------------------------------------------
|
| This is the main (and only) class that helps you
| work with Accsmaster api. It allows you to basically use all
...
class ResellerSDK
{
    ...
    {
        $this->baseUrl = 'https://accsmaster.com/api/v1/';
    ...
    /**
     * Post request to 'https://accsmaster.com/api/v1/user'
     *
    ...
    /**
     * Post request to 'https://accsmaster.com/api/v1/user/refresh'
     *
     * @return string
     */
    ...
    /**
     * Post request to 'https://accsmaster.com/api/v1/user/invalidate'
     *
     * @return bool
     */
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/offers'
     *
     * category_id: int
     * product_id:  int
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/offer'
     *
     * id: int
     *
     * Data example: ['id' => 100]
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/categories'
     *
     * @return array
     */
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/orders'
     *
     * @return array
     */
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/order'
     *
     * @param array $data
     * @return array
     */
    ...
    /**
     * Get request to 'https://accsmaster.com/api/v1/user'
     *
     * @return array
     */
